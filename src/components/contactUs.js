...
// const Kembali = Loadable({
//     loader: () => import('./Kembali'),
//     loading() {
            ...
            <form onSubmit={this.handleSubmit} className="contactUs-form">
                ...
                <label className= "contactUs-label4">
                        <span>
                            ...
                            {this.state.enabled?<input type="submit" value="Kirim" className= "button contactUs-submit"  />:<input type="submit" value="Kirim" className= "button contactUs-submitdisable "disabled/>}
<br/>
<br/>
            </form>
        </div>
